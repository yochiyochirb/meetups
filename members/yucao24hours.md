...
## 一番お世話になっている技術系サイトなど
APIdock とかは別次元として、一般的な(?) サービスだと [Stack Overflow](http://stackoverflow.com) です。ベタですがほんとに助かっております。

ところでこの「スタックオーバーフロー」って何のことかわかる人のほうが最近は少ないんじゃないだろうか、と数日前にふと思いました。
